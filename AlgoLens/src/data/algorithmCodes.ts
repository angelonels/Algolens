// Re-export language config for backward compatibility
export { type CodeLanguage, type AlgorithmCodes, LANGUAGES, STORAGE_KEY, getStoredLanguage, setStoredLanguage } from './languageConfig'
import type { AlgorithmCodes } from './languageConfig'
