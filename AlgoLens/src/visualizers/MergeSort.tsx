...
export default function MergeSortVisualizer() {
  ...
  const startSort = () => { setSteps(computeMergeSortSteps(INIT)); setCurrentStep(0); setSorting(true); setIsPaused(false) }
  ...
  const step = steps[currentStep] ?? { snapshot: INIT, phase: 'idle', range: null, depth: 0, message: '' } as MergeSortStep
