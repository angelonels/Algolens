    ...
    <div className="pt-28 pb-20 px-6 sm:px-10 lg:px-16 max-w-[1280px] mx-auto min-h-screen">
      ...
      >
        ...
        <p style={{ fontSize: 14, color: 'var(--fg-muted)', maxWidth: 720, lineHeight: 1.6 }}>
          Compare runtime, memory, stability, and learning context before opening a visualizer. This
          page is now driven from the same registry as the actual routes, so metadata and navigation
          stay aligned.
        </p>
      </motion.div>
            ...
            <AnimatePresence mode="popLayout">
              {sorted.map((entry, index) => (
                ...
                >
                  ...
                  <td style={{ ...cellStyle, minWidth: 220, whiteSpace: 'normal' }}>
                    {entry.useCase}
                  </td>
                  <td
                    style={{
