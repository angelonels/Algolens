    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            Interactive algorithm visualizer with step-by-step animations and multi-language code
            examples.
          </p>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <span style={{ fontSize: 12, color: 'var(--fg-muted)' }}>
              <strong style={{ color: 'var(--fg)', fontWeight: 700 }}>{ALGORITHMS.length}</strong>{' '}
              Algorithms
            </span>
            <span style={{ fontSize: 12, color: 'var(--fg-muted)' }}>
