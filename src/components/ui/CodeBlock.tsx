  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className={`absolute top-3 right-3 px-3.5 py-1.5 font-mono text-[11px] font-semibold uppercase tracking-wider cursor-pointer transition-all rounded-sm ${
          copied
