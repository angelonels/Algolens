...
export const complexityRegistry: ComplexityEntry[] = [
  ...
  },
  {
    ...
    slug: 'insertion-sort',
    category: 'sorting',
    complexity: insertionSortComplexity,
  },
  {
    name: 'Selection Sort',
    slug: 'selection-sort',
  ...
  // Dynamic Programming
  {
    ...
    slug: 'edit-distance',
    category: 'dp',
    complexity: editDistanceComplexity,
  },
  {
    name: 'Spiral Matrix Traversal',
    slug: 'matrix-traversal',
    category: 'dp',
    complexity: matrixTraversalComplexity,
  },
  ...
  // Math
  {
    ...
    slug: 'euclidean-gcd',
    category: 'math',
    complexity: euclideanGCDComplexity,
  },
  ...
  { name: 'K-Means Clustering', slug: 'k-means', category: 'ml', complexity: kMeansComplexity },
  {
    ...
    category: 'ml',
    complexity: linearRegressionComplexity,
  },
  {
    name: 'Logistic Regression',
    slug: 'logistic-regression',
    category: 'ml',
    complexity: logisticRegressionComplexity,
  },
  {
    name: 'Decision Tree',
    slug: 'decision-tree',
    category: 'ml',
    complexity: decisionTreeComplexity,
  },
];
