...
export default function BubbleSortVisualizer() {
  ...
  ] = useAlgorithmPlayback<BubbleSortStep>();
        ...
        <SplitLeft>
          <ExplanationBox>
            ...
            <p className="text-[var(--fg-muted)] text-sm leading-relaxed">
              Bubble Sort repeatedly steps through the list, compares adjacent pairs, and swaps them
              if needed. Smaller elements "bubble" to the front, larger ones sink to the end.
            </p>
              ...
              {step.array.map((v, i) => (
                <motion.div
                  ...
                  animate={{
                    ...
                    y: step.swapping && step.compare.includes(i) ? -10 : 0,
                  }}
                  transition={{
                    ...SPRING.bouncy,
