...
export default function InsertionSortVisualizer() {
  const [
    { steps, currentStep, isRunning, isPaused, speed, isFinalStep },
    { start, reset, togglePause, setSpeed },
  ] = useAlgorithmPlayback<InsertionSortStep>();
        ...
        <SplitLeft>
          <ExplanationBox>
            ...
            <p className="text-[var(--fg-muted)] text-sm leading-relaxed">
              Insertion Sort builds the sorted array one element at a time — like sorting playing
              cards in your hand. Extract each element, slide it left until it finds its correct
              position.
            </p>
            ...
            <div className="mt-4 pt-3 border-t border-[var(--border)] text-xs text-[var(--fg-muted)] space-y-0.5">
              <p>
                <strong>Time:</strong> O(n²) average/worst | O(n) best
              </p>
              <p>
                <strong>Space:</strong> O(1) | <strong>Stable:</strong> Yes |{' '}
        ...
        <SplitRight>
          <VisualizationContainer>
            ...
            <div className="flex justify-center items-end gap-1.5 h-[280px] py-5">
              {step.snapshot.map((v, i) => (
                <motion.div
                  ...
                  style={{
                    color: [step.keyIndex, step.comparingIndex, step.shiftIndex].includes(i)
                      ? '#fff'
                      : 'var(--fg)',
                  }}
                >
            ...
            <ControlsRow>
              ...
              <ControlButton onClick={startSort} disabled={isRunning && !isPaused}>
