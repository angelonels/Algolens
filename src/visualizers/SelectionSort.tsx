...
export default function SelectionSortVisualizer() {
  ...
  const startSort = () => {
    setSteps(computeSelectionSortSteps(INIT));
    setCurrentStep(0);
    setSorting(true);
    setIsPaused(false);
  };
        ...
        <SplitLeft>
          <ExplanationBox>
            ...
            <div className="mt-4 pt-3 border-t border-[var(--border)] text-xs text-[var(--fg-muted)] space-y-0.5">
              <p>
                <strong>Time:</strong> O(n²) average/worst/best
              </p>
              <p>
              ...
              {step.array.map((v, i) => (
                <motion.div
                  ...
                  animate={{
                    ...
                    scale:
                      step.swapIndices.includes(i) || i === step.scanning || i === step.minIdx
                        ? 1.04
                        : 1,
