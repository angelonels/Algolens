...
export default function HeapSortVisualizer() {
  ...
  const startSort = () => {
    setSteps(computeHeapSortSteps(INIT));
    setCurrentStep(0);
    setSorting(true);
    setIsPaused(false);
  };
        ...
        <SplitLeft>
          <ExplanationBox>
            ...
            <p className="text-[var(--fg-muted)] text-sm leading-relaxed">
              Heap Sort uses a binary heap data structure to sort elements. It first builds a max
              heap, then repeatedly extracts the maximum element and places it at the end.
            </p>
            ...
            <div className="mt-4 pt-3 border-t border-[var(--border)] text-xs text-[var(--fg-muted)] space-y-0.5">
              <p>
                <strong>Time:</strong> O(n log n) average/worst/best
              </p>
              <p>
                <strong>Space:</strong> O(1) | <strong>Stable:</strong> No
              </p>
            </div>
          </ExplanationBox>
